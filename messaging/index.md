...
Open Road Code deliberately separates <strong>state dissemination</strong> from <strong>commands</strong>. Telemetry that many independent consumers may observe uses ZeroMQ PUB/SUB. Operations that require an acknowledgement or failure response use ZeroMQ REQ/REP.
...
<table><thead><tr><th>Topic</th><th>Owner / producer</th><th>Purpose</th><th>IDD</th><th>Status</th></tr></thead><tbody>
...
<table><thead><tr><th>Command</th><th>Arguments</th><th>Response</th><th>IDD</th><th>Status</th></tr></thead><tbody>
