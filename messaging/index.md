...
<tr><td data-label="Topic"><code>openroad.navigation.position</code></td><td data-label="Owner">Navigation service / NavigationStatePublisher</td><td data-label="Purpose">Absolute geographic position, altitude, speed, course, GNSS fix and satellite metadata.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/master/docs/idd/navigation_position_state.md">Navigation Position State</a></td><td data-label="Status">master</td></tr>
<tr><td data-label="Topic"><code>openroad.navigation.motion</code></td><td data-label="Owner">Navigation service / NavigationStatePublisher</td><td data-label="Purpose">Heading, ground speed, vertical speed, turn rate, and motion cache state.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/master/docs/messaging/message_bus_idd.md">Message Bus IDD</a></td><td data-label="Status">master</td></tr>
<tr><td data-label="Topic"><code>openroad.navigation.attitude</code></td><td data-label="Owner">Navigation service / NavigationStatePublisher</td><td data-label="Purpose">Fused heading, pitch, and roll orientation.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/master/docs/messaging/message_bus_idd.md">Message Bus IDD</a></td><td data-label="Status">master</td></tr>
<tr><td data-label="Topic"><code>openroad.navigation.imu</code></td><td data-label="Owner">Navigation service / NavigationStatePublisher</td><td data-label="Purpose">Acceleration, linear acceleration, and angular velocity XYZ vectors.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/master/docs/messaging/message_bus_idd.md">Message Bus IDD</a></td><td data-label="Status">master</td></tr>
<tr><td data-label="Topic"><code>openroad.vehicle.state</code></td><td data-label="Owner">Automotive service / VehicleStatePublisher</td><td data-label="Purpose">Normalized vehicle telemetry including engine speed, vehicle speed, throttle, pressures, temperatures, fuel level, airflow, and control voltage.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/master/docs/idd/automotive_vehicle_state.md">Automotive Vehicle State</a></td><td data-label="Status">master</td></tr>
<tr><td data-label="Topic"><code>route_guidance.state</code></td><td data-label="Owner">Navigation session / RouteGuidancePublisher</td><td data-label="Purpose">Active-route progress, remaining distance, maneuver instructions, off-route state, and route-complete state.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/navigation_zmq/docs/idd/route_guidance_state.md">Route Guidance State</a></td><td data-label="Status"><code>navigation_zmq</code></td></tr>
</tbody></table></div>
...
<tr><td data-label="Command"><code>navigation.calibrate_stationary</code></td><td data-label="Arguments"><code>sample_count</code> (default 100), <code>sample_interval_s</code> (default 0.01)</td><td data-label="Response">Success/failure acknowledgement. Successful message: stationary calibration complete.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/navigation_zmq/docs/idd/navigation_command_service.md">Navigation Command Service</a></td><td data-label="Status"><code>navigation_zmq</code></td></tr>
<tr><td data-label="Command"><code>navigation.reset_heading</code></td><td data-label="Arguments"><code>heading_deg</code> (default 0.0)</td><td data-label="Response">Success/failure acknowledgement. Successful message: heading reset complete.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/navigation_zmq/docs/idd/navigation_command_service.md">Navigation Command Service</a></td><td data-label="Status"><code>navigation_zmq</code></td></tr>
<tr><td data-label="Command"><code>navigation.route.calculate</code></td><td data-label="Arguments">Origin, destination, and travel mode: <code>AUTO</code>, <code>BICYCLE</code>, <code>PEDESTRIAN</code>, or <code>MOTORCYCLE</code>.</td><td data-label="Response">Route distance/duration, shape points, and maneuver list, or a structured failure response.</td><td data-label="IDD"><a href="https://github.com/markisrt4/OpenRoadCode/blob/navigation_zmq/docs/idd/navigation_command_service.md">Navigation Command Service</a></td><td data-label="Status"><code>navigation_zmq</code></td></tr>
</tbody></table></div>
...
<tr><td data-label="Layer"><code>messaging/contracts/</code></td><td data-label="Responsibility">Public topic names, JSON message representations, codecs, validators, decoders, and publisher helpers.</td></tr>
<tr><td data-label="Layer"><code>messaging/zeromq/</code></td><td data-label="Responsibility">ZeroMQ transport primitives, endpoints, broker, publisher, and subscriber implementation.</td></tr>
<tr><td data-label="Layer"><code>services/navigation/</code></td><td data-label="Responsibility">Owns the live navigation controller, publishes navigation state, and executes navigation command semantics.</td></tr>
<tr><td data-label="Layer"><code>services/automotive/</code></td><td data-label="Responsibility">Owns automotive acquisition/runtime and publishes normalized vehicle state.</td></tr>
<tr><td data-label="Layer"><code>docs/idd/</code></td><td data-label="Responsibility">Normative domain interface definitions: field meanings, types, units, ranges, nullability, framing, producer rules, and consumer rules.</td></tr>
<tr><td data-label="Layer"><code>docs/messaging/message_bus_idd.md</code></td><td data-label="Responsibility">Normative bus-level topology, framing, lifecycle, threading, configuration, and extension rules.</td></tr>
</tbody></table></div>
